...
export default function About() {
  return (
    <article
      className='max-w-lg rounded-md text-slate-100
    ...
    >
      <header className='flex justify-center items-center gap-8 flex-col md:flex-row'>
        <div className='flex flex-col gap-5 font-medium self-center md:self-auto'>
          ...
          <a
            className='p-1 bg-yellow-300 text-blue-800 w-fit rounded-sm font-bold self-center hover:bg-yellow-400 transition'
